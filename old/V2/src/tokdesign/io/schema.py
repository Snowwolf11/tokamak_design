...
_SCHEMA_V01: Dict[str, List[str]] = {
    ...
    "target": [
        "/target",
        "/target/boundary",  # LCFS target polyline
        "/target/psi_boundary",
    ...
    "fixed_eq": [
        ...
        "/equilibrium/fixed/psi",
        "/equilibrium/fixed/psi_axis",
        "/equilibrium/fixed/psi_lcfs",

        "/equilibrium/fixed/p_psi",
        "/equilibrium/fixed/F_psi",

        "/equilibrium/fixed/plasma_mask",
        "/equilibrium/fixed/jphi",

        "/equilibrium/fixed/fields",
        "/equilibrium/fixed/fields/BR",
        "/equilibrium/fixed/fields/BZ",
        "/equilibrium/fixed/fields/Bphi",

        "/equilibrium/fixed/derived",
        "/equilibrium/fixed/derived/Ip",
        "/equilibrium/fixed/derived/beta_p",
        "/equilibrium/fixed/derived/li",
        "/equilibrium/fixed/derived/kappa",
        "/equilibrium/fixed/derived/delta",
        "/equilibrium/fixed/derived/q_profile",
    ],
    ...
    "free_eq": [
        ...
        "/equilibrium/free/psi_total",
        "/equilibrium/free/psi_vac",
        "/equilibrium/free/psi_plasma",
        "/equilibrium/free/lcfs_poly",

        "/equilibrium/free/psi_axis",
        "/equilibrium/free/psi_lcfs",
        "/equilibrium/free/p_psi",
        "/equilibrium/free/F_psi",
        "/equilibrium/free/plasma_mask",
        "/equilibrium/free/jphi",

        "/equilibrium/free/fields",
        "/equilibrium/free/fields/BR",
        "/equilibrium/free/fields/BZ",
        "/equilibrium/free/fields/Bphi",

        "/equilibrium/free/derived",
        "/equilibrium/free/derived/Ip",
        "/equilibrium/free/derived/beta_p",
        "/equilibrium/free/derived/li",
        "/equilibrium/free/derived/kappa",
        "/equilibrium/free/derived/delta",
        "/equilibrium/free/derived/q_profile",

        # Solver bookkeeping (recommended for robustness & scans)
        "/equilibrium/free/history",
        "/equilibrium/free/history/outer_iter",
        "/equilibrium/free/history/lcfs_rms",
        "/equilibrium/free/history/Ip",
        "/equilibrium/free/history/dIp_rel",
        "/equilibrium/free/history/alpha_lcfs",
        "/equilibrium/free/history/alpha_plasma",

        "/equilibrium/free/convergence",
        "/equilibrium/free/convergence/converged",
        "/equilibrium/free/convergence/n_outer_iter",
        "/equilibrium/free/convergence/stop_reason",

        # Analysis is not implemented yet, but you can keep these as "complete goal"
        "/analysis",
