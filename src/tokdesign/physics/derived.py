...
from tokdesign.physics.gs_profiles import normalize_psi
...
if __name__ == "__main__":
    ...
    from tokdesign.physics.fields import compute_BR_BZ_from_psi
    from tokdesign.physics.gs_profiles import GSProfiles, PressureProfile, ToroidalFieldFunction, normalize_psi
