...
from tokdesign.physics.gs_operator import build_delta_star_matrix, build_index_map, apply_dirichlet
from tokdesign.physics.gs_profiles import GSProfiles, jphi_from_psi, MU0
...
if __name__ == "__main__":
    ...
    from tokdesign.geometry.grids import make_rz_grid
    from tokdesign.geometry.plasma_boundary import miller_boundary
    from tokdesign.physics.gs_profiles import profiles_from_dict
